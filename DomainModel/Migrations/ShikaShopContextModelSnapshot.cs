...
namespace DomainModel.Migrations
{
    ...
    partial class ShikaShopContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainModel.Models.Chat", b =>
                {
            ...
            modelBuilder.Entity("DomainModel.Models.ChatRoom", b =>
                {
                    b.Property<int>("ChatRoomId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("recaivingUserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainModel.Models.Chat", b =>
                {
                    b.HasOne("DomainModel.Models.ChatRoom", "ChatRoom")
                        .WithMany("chats")
            ...
            modelBuilder.Entity("DomainModel.Models.ChatRoom", b =>
                {
                    b.HasOne("DomainModel.Models.User", "sendingUser")
                        .WithMany("sendingUserChatRoom")
                        .HasForeignKey("SendUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DomainModel.Models.User", "recaivingUser")
                        .WithMany("recaivingUserChatRoom")
                        .HasForeignKey("recaivingUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("recaivingUser");
            ...
            modelBuilder.Entity("DomainModel.Models.User", b =>
                {
                    ...
                    b.Navigation("recaivingUserChatRoom");

                    b.Navigation("sendingUserChatRoom");
                });
